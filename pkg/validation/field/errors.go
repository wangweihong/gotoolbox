...
import (
	...
	utilerrors "github.com/wangweihong/gotoolbox/pkg/errors"
...
func fromAggregate(agg utilerrors.Aggregate) ErrorList {
	...
	for i := range errs {
		list[i] = errs[i].(*Error) //nolint: errorlint
	}
	return list
}
...
func (list ErrorList) Filter(fns ...utilerrors.Matcher) ErrorList {
	...
	return fromAggregate(err.(utilerrors.Aggregate)) //nolint: errorlint
}
